...
CONSUMER_KEY = "9"
CONSUMER_SECRET = "9"
OATH_TOKEN = "9" # oauth token for ebooks account
OAUTH_TOKEN_SECRET = "9" # oauth secret for ebooks account

ROBOT_ID = "ebooks" # Avoid infinite reply chains
TWITTER_USERNAME = "9" # Ebooks account username
TEXT_MODEL_NAME = "9" # This should be the name of the text model
